...
heat_ews_demo.py – run from command line, saves 9 charts to demo_output folder. Examples of output are included in the files. Write anuadhapura_data_template.csv for DOM to fill in real observations
There are three command line models: built in sythetic; full year with MAr-May peak; real DOM observations
