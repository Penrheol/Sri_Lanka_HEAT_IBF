...
for temperature / heat index thresholds in Anuradhapura District.
...
# ─────────────────────────────────────────────────────────────
# 9. SYNTHETIC DEMO DATA  (Anuradhapura climatological profile)
# ─────────────────────────────────────────────────────────────

def generate_demo_data(n_train: int = 180, n_test: int = 90,
                       seed: int = 42) -> tuple:
    """Generate synthetic heat data mimicking Anuradhapura Dry Zone.
...
def run_demo():
    ...
    print("  Anuradhapura District, Sri Lanka")
    print("=" * 60)
    ...
    # ── Threshold display ──────────────────────────────────
    print("\n── Current Heat Index Thresholds (Anuradhapura Pilot) ──")
    ...
    print("  1. Replace generate_demo_data() with real Anuradhapura observations")
